...
- Product role: CLI and SDK for checking agent intent, action ledgers, and scope policy.
- Tool-specific motif: verdict rows, scope pressure, and report packet.
